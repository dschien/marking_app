...
def plot_radar(spoke_labels, average, values, file_name, name):
    # global N, theta, spoke_labels, a, b, fig, title_list, data, colors, radial_grid, n, title, ax, d, color, labels, legend
    ...
    plt.figtext(0.5, 0.965, 'Marks compared with course average',
...
if __name__ == '__main__':
    spoke_labels = ['Data Quality', 'Disussion', 'Methodology', 'Results', 'Tool', 'Consequential']
    a = [0.88, 0.6, 0.7, 0.3, 0.30, 0.6]  # [6, 7, 5, 6, 8, 4]
    a = np.asarray(a) * 10
    b = [0.5, 0.6, 0.8, 0.7, 0.8, 0.4]
    b = np.asarray(b) * 10
    plot_radar(spoke_labels, a,b, '../test_plot.png')